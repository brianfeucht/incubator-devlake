...
// PostConnections creates a new Sentry connection.
...
// PatchConnection updates an existing Sentry connection.
func PatchConnection(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
connection := &models.SentryConnection{}
if err := connectionHelper.First(connection, input.Params); err != nil {
return nil, err
}
if err := connection.MergeFromRequest(connection, input.Body); err != nil {
...
// DeleteConnection removes a Sentry connection.
func DeleteConnection(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
conn := &models.SentryConnection{}
...
// ListConnections returns all Sentry connections.
func ListConnections(input *plugin.ApiResourceInput) (*plugin.ApiResourceOutput, errors.Error) {
var connections []models.SentryConnection
...
// GetConnection returns a single Sentry connection.
...
func validateConnection(c *models.SentryConnection) errors.Error {
if c == nil {
