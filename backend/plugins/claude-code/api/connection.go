...
// PatchConnection updates an existing Claude connection.
...
// DeleteConnection removes a Claude connection.
...
// ListConnections returns all Claude connections.
...
// GetConnection returns a single Claude connection.
...
func validateConnection(c *models.ClaudeConnection) errors.Error {
	if c == nil {
