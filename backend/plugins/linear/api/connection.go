...
// PostConnections creates a new Linear connection.
...
// PatchConnection updates an existing Linear connection.
...
// DeleteConnection removes a Linear connection.
...
// ListConnections returns all Linear connections.
...
// GetConnection returns a single Linear connection.
...
func validateConnection(c *models.LinearConnection) errors.Error {
	if c == nil {
